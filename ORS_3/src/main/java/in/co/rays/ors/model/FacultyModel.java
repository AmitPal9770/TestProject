...
public class FacultyModel implements FacultyModelInt{
...
//		System.out.println("faculty add fbn");
		FacultyDTO duplicateFacultyName = findByEmail(bean.getFirstName());
...
//		System.out.println("faculty add try block started");
	...
	//		System.out.println("faculty add try block");
			...
			CollegeDTO cbean = cmodel.findbypk(bean.getCollegeid());
...
//			System.out.println("qualification");
	...
	public void update(FacultyDTO bean) throws ApplicationException, DuplicateRecordException {
	   ...
	   String subjectname = sbean.getSubjectName();
		...
		FacultyDTO beanExist = findByEmail(bean.getFirstName());
