 ...
 * Copyright (c) SunilOS
 */
public class MarksheetModel implements MarksheetModelInt{
    ...
    public MarksheetDTO findbyRollNo(String rollNo)
        ...
        Connection conn = null;
        try {
        	System.out.println("tryyyyyyyyyyyyyyyy"+rollNo);
            conn = JDBCDataSource.getConnection();
            PreparedStatement pstmt = conn.prepareStatement(sql.toString());
            System.out.println("pstmytttttttttttt");
            pstmt.setString(1, rollNo);
            ResultSet rs = pstmt.executeQuery();
            System.out.println("rsmmmmmmmmmmmmmmmm"+rollNo);
            while (rs.next()) {
            	System.out.println("whillllllllllllll");
    ...
    public void update(MarksheetDTO bean) throws ApplicationException,
        ...
        bean.setStudentname(studentbean.getFirstName() + " " + studentbean.getLastName());
...
/*            System.out.println("service" + bean.getName());*/
            ...
            if (bean.getStudentname() != null && bean.getStudentname().length() > 0) {
                sql.append(" AND name like '" + bean.getStudentname() + "%'");
            }
