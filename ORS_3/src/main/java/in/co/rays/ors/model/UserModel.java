...
public class UserModel implements UserModelInt{
	 ...
	 * 
	 */
	public long add(UserDTO bean) throws DuplicateRecordException, RecordNotFoundException, ApplicationException {
...
//		System.out.println("sql" + sql);
	...
	public void update(UserDTO bean) throws ApplicationException, DuplicateRecordException, RecordNotFoundException {
		log.debug("Model update Started");
		Connection conn = null;

		UserDTO beanExist = findbylogin(bean.getLogin());
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE ST_USER SET FIRST_NAME=?,LAST_NAME=?,LOGIN=?,PASSWORD=?,DOB=?,MOBILE_NO=?,ROLE_ID=?,UNSUCCESFUL_LOGIN=?,GENDER=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
...
// Calculate start record index
	...
	public boolean changePassword(long id, String password, String oldPassword)
		...
		if (beanExist != null && beanExist.getPassword().equals(oldPassword)) {
			beanExist.setPassword(password);
			try {
				update(beanExist);
...
*/
	...
	public long registerUser(UserDTO bean) throws DuplicateRecordException, RecordNotFoundException, ApplicationException {
