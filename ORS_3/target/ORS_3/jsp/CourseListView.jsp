...
<%@page import="in.co.rays.ors.controller.CourseListCtl"%>
...
<div class="content">
<jsp:useBean id="dto" class="in.co.rays.ors.dto.CourseDTO" scope="request"></jsp:useBean>
	  <h2 align="center" style="color: red">Course List</h2>
...
<div  class="col-sm-3 col-xl-3">
  <div style="padding-bottom: 10px" class=" form-group has-search active-purple-2">
    ...
    <span class=" form-control-feedback"></span>
     <input type="text" class="form-control form-control-sm sm ml-0 w-15" name="name" placeholder="Enter Course Name">
  </div>
 </div>

  <div  class="col">
  <div  class="form-group" style="padding-bottom: 10px">
  <button class="btn btn-success" type="submit" name="operation" value="<%=CourseListCtl.OP_SEARCH%>">Search</button>
  </div>
  </div>
  
  <div class="col">
  <div  class="form-group" style="padding-bottom: 10px">
  <button class="btn btn-warning" type="submit" name="operation" value="<%=CourseListCtl.OP_RESET%>">Reset</button>
  </div>
  </div>
  
<div  class="col">
  <div  class="form-group" style="padding-bottom: 10px">
  <button style="background-color: green ; color: white" align="right" class="btn" name="operation" value="<%=CourseCtl.OP_NEW %>">
...
while(it.hasNext()){
  ...
  <tbody align="center">
    ...
    <td><input type="checkbox" class="checkbox" name="ids" value="<%=dto.getId()%>"></td>
     ...
     <td><%=dto.getDescription()%></td>
      <td><a style="color: #FF5733" href="CourseCtl?id=<%=dto.getId() %>">
      <i class="fa fa-pencil-square-o" style="color:blue" aria-hidden="true"></i>
      </a>
      </td>
      <td>
      <button type="submit"  class="btn btn-link text-primary" name="operation" value="<%=CourseListCtl.OP_DELETE%>"><i class="fa fa-trash fa1"></i></button>
      </td>
    </tr>   
  </tbody>
 <%} %> 
 ...
 <div  class="col">
  <div  class="form-group" style="padding-bottom: 10px">
  <button style="background-color: blue; color: white" class="btn blue-gradient btn-rounded btn-sm my-0" type="submit" name="operation" value="<%=CourseListCtl.OP_PREVIOUS%>"
 ...
 <div  class="col" align="right">
  <div  class="form-group" style="padding-bottom: 10px">
  <button style="background-color: blue; color: white" class="btn blue-gradient btn-rounded btn-sm my-0" type="submit" name="operation" value="<%=CourseListCtl.OP_NEXT%>"
...
<%if(list.size()==0){ %>
<div align="center">
<button class="btn btn-primary " name="operation" value="<%=CourseListCtl.OP_BACK%>">Back</button>
</div>
<%} %>
</form>
</div>
