...
<%@page import="in.co.rays.ors.controller.SubjectListCtl"%>
...
<div class="content">
<jsp:useBean id="dto" class="in.co.rays.ors.dto.SubjectDTO" scope="request"></jsp:useBean>
	  <h2 align="center" style="color: red">Subject List</h2>
...
<!--     <span class=" form-control-feedback"></span> -->
 ...
 <%=HTMLUtility.getList("coursename", String.valueOf(dto.getCourseId()), cclist) %>
  ...
  <button class="btn btn-success" type="submit" name="operation" value="<%=SubjectCtl.OP_SEARCH%>">Search</button>
  </div>
  </div>
  
  <div class="col">
  <div  class="form-group" style="padding-bottom: 10px">
  <button class="btn btn-warning" type="submit" name="operation" value="<%=SubjectCtl.OP_RESET%>">Reset</button>
  </div>
  </div>
  
<div  class="col">
  <div  class="form-group" style="padding-bottom: 10px">
  <button style="background-color: green ; color: white" align="right" class="btn" name="operation" value="<%=SubjectCtl.OP_NEW %>">
...
while(it.hasNext()){
	    ...
	    CourseDTO dtoo = model.findbypk(dto.getCourseId()); 
 ...
 %>
  <tbody align="center">
    ...
    <td><input type="checkbox" class="checkbox" name="ids" value="<%=dto.getId()%>"></td>
     ...
     <td><a style="color: #FF5733" href="SubjectCtl?id=<%=dto.getId() %>">
      <i class="fa fa-pencil-square-o" style="color:blue" aria-hidden="true"></i>
      </a>
      </td>
      <td>
      <button type="submit"  class="btn btn-link text-primary" name="operation" value="<%=SubjectListCtl.OP_DELETE%>"><i class="fa fa-trash fa1"></i></button>
      </td>
    </tr>   
  </tbody>
 <%} %> 
 ...
 <div  class="col">
  <div  class="form-group" style="padding-bottom: 10px">
  <button style="background-color: blue; color: white" class="btn blue-gradient btn-rounded btn-sm my-0" type="submit" name="operation" value="<%=SubjectListCtl.OP_PREVIOUS%>"
 ...
 <div  class="col" align="right">
  <div  class="form-group" style="padding-bottom: 10px">
  <button style="background-color: blue; color: white" class="btn blue-gradient btn-rounded btn-sm my-0" type="submit" name="operation" value="<%=SubjectListCtl.OP_NEXT%>"
...
<%if(list.size()==0){ %>
<div align="center">
<button class="btn btn-primary " name="operation" value="<%=SubjectListCtl.OP_BACK%>">Back</button>
</div>
<%} %>
</form>
</div>
